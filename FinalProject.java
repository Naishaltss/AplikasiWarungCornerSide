...
Scanner sc = new Scanner(System.in);
        int pilih =0, pilih1=0, pilih2=0, pilih3, pilih4, pilih5=0, pilih6=0,pilih7;
                      ...
                      pilih1 = sc.nextInt(); 
                        switch(pilih1){
                                ...
                                do{
                                    ...
                                    switch(pilih2){
                                        case 1:
                                            ...
                                            System.out.println("");
                                            System.out.println("Tambahkan " + nmenumkn + " [" + hmenumkn + "]?");
                            ...
                            case 2:
                                            ...
                                            nmenumnm = sc.next(); 
                                            System.out.print("Masukan Harga Paku: ");
                                            hmenumnm = sc.nextInt(); 
                                            int j = -1; 
                                            do{
                                                j++; 
                                            ...
                                            System.out.println("");
                                            System.out.println("Tambahkan " + nmenumnm + " [" + hmenumnm + "]?");
                                            System.out.println("1. Tambah"); 
                                            System.out.println("2. Batal"); 
                                            System.out.print("Pilih: ");
                                            pilih4 = sc.nextInt(); 
                            ...
                            case 2: 
                                do{
                                    ...
                                    switch(pilih6){
                                        case 1: 
                                            System.out.println(""); 
                                            System.out.print("Masukan Nama Jenis Makanan Yang Akan Diubah: ");
                                            ubahmakan = sc.next(); 
                                            ...
                                            thmkn = sc.nextInt(); 
                                            System.out.println("");
                                            System.out.println("Ubah Paku " + ubahmakan + " Menjadi " + tubahmkn + "Dengan Harga Rp." +thmkn+"?"); 
                                ...
                                do{
                                    ...
                                    switch(pilih10){
                                     case 1: 
                                            ...
                                            if(pilih11 == 1){
                                                for (int i = 0; i < menumkn.length; i++) {
                                                    if(menumkn[i] != null && hpsmkn.equalsIgnoreCase(menumkn[i].getNama()) && menumkn[i+1] != null){ 
                                                        menumkn[i] = null; 
                                        ...
                                        case 2: 
                                            ...
                                            if(pilih12 == 1){
                                                for (int i = 0; i < menumnm.length; i++) {
                                                    if(menumnm[i] != null && hpsmnm.equalsIgnoreCase(menumnm[i].getNama()) && menumnm[i+1] != null){ 
                                                        menumnm[i] = null; 
                                ...
                                do{
                                    ...
                                    switch(pilih14){
                                        case 1: 
                                            ...
                                            for (int i = 0; i < menumkn.length; i++) {
                                                if(menumkn[i] != null){
                                                    System.out.println((i+1) + ". " + menumkn[i].getNama() + " [" + menumkn[i].getHarga() + "] ");
                                                    j++; 
                                                }
                                            }
                                        break; 
                                         case 2:
                                            ...
                                            for (int i = 0; i < menumnm.length; i++) {
                                                if(menumnm[i] != null){
                                                    System.out.println((i+1) + ". " + menumnm[i].getNama() + " [" + menumnm[i].getHarga() + "] ");
                                                    j++; 
                                                }
                                            }
                                        break; 
